...
export type HitDatepickerFieldProps<
 ...
 *    control={hf.control}
 *    render={(field) => <HitDatepickerField {...field} label="Birthdate"/>}
 *  />
 */

export const HitDatepickerField = <TValue extends FieldValues>({
  label,
  colSpan,
  floatingLabel = true,
  field,
  ...
  textFieldProps,
  ...props
}: HitDatepickerFieldProps<TValue>) => {
  const id = useId();
  return (
