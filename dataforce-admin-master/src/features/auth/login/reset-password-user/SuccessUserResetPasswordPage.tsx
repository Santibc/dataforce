...
export const SuccessUserResetPasswordPage = () => {
    ...
    return (
        <>
            ...
            <Helmet>
                <title> Password Successfully Reset | BosMetrics </title>
            </Helmet>
            <Box sx={{ height: '100%' }}>
                <Container
                    ...
                    <MotionContainer>
                        ...
                        <m.div variants={varBounce().in}>
                            <Typography sx={{ color: 'text.secondary', display: 'flex', justifyContent: 'center' }}>
                                Your password was successfully reset! You can now close this window.
                            </Typography>
                        </m.div>
                        <m.div
                            style={{
