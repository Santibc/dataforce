...
import { useSAUpdateChatGroupMutation } from 'src/api/superAdminChatRepository';
...
export function SuperAdminChatGroupEditDialog({ open, onClose, group }: Props) {
  const updateMutation = useSAUpdateChatGroupMutation();
