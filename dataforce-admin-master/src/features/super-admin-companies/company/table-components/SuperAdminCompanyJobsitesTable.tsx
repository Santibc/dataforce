...
interface SuperAdminCompanyJobsitesTableProps {
...
export const SuperAdminCompanyJobsitesTable: React.FC<SuperAdminCompanyJobsitesTableProps> = ({
    data,
    isLoading,
    onDelete,
    onEdit,
            ...
            >
                <MenuItem
                    onClick={() => {
                        ...
                        chainConfirm(confirm, [
                            ...
                            {
                                content: 'Are you REALLY sure you want to delete this jobsite? This will affect the company\'s whole system',
                ...
                <MenuItem
                    onClick={() => {
                        ...
                        chainConfirm(confirm, [
                            {
                                content: 'Are you sure you want to edit this jobsite?',
                                actionLabel: 'Yes'
                            },
                            {
                                content: 'Are you REALLY sure you want to edit this jobsite? This will affect the company\'s whole system',
